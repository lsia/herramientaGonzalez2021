...
namespace KSDExperiments.Experiments
{
    class CollectAverageNGrams : PipelineStage
    {
        ...
        void CollectAverages(string name, Session session, int[] timing, int order)
        {
        ...
        public static Dictionary<ulong,double> GetAverageNGrams(Session session, TypingFeature feature, int order)
        {
