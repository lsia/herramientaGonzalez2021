...
using KSDExperiments.FiniteContexts.ContextSelection;
using KSDExperiments.FiniteContexts.Models;
using KSDExperiments.FiniteContexts.ModelStorages;


namespace KSDExperiments.FiniteContexts.PatternVector
{
    public class Builder
    {
        ...
        */
        ...
        public delegate void OnModelChosenDelegate(TypingFeature feature, Session session, int pos, ulong context, Model[] candidates, Model chosen);
        public event OnModelChosenDelegate OnModelChosen;

//        public Model[] ChosenModels;

        public Model[] Rebuild(Session session)
        {
