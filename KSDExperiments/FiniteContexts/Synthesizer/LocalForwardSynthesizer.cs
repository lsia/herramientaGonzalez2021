...
namespace KSDExperiments.FiniteContexts.Synthesizer
{
    abstract class LocalForwardSynthesizer<T> : KeystrokeDynamicsSynthesizer where T : Model
    {
        ...
        public int[] ForEachModel(TypingFeature feature, Session dummy) 
        {
        ...
        public virtual void OnSynthesizeFeatureStart(TypingFeature feature, Session dummy) { }
        public override int[] SynthesizeFeature(TypingFeature feature, Session dummy)
        {
